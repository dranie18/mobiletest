...
class OfferDetails extends Offer {
  ...
  final SelfLink acceptOfferLink;
  final SelfLink rejectOfferLink;
  ...
  OfferDetails({
    ...
    @required this.acceptOfferLink,
    @required this.rejectOfferLink,
    ...
    @required Address requestAddress,
        ...
        assert(acceptOfferLink != null),
        assert(rejectOfferLink != null),
